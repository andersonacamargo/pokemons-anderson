  ...
  return (
    <div className="main-bg">
      <div className="container">
        ...
        <div className="card">
          <p>
            <strong>Nome:</strong> {trainer.name}
          </p>
          ...
          <p>
            <strong>Idade:</strong> {trainer.age}
          </p>
          <p>
            <strong>Pokémons:</strong> {pokemonCount}
          </p>
          <p>
            <strong>Insigneas:</strong> {badges}
          </p>
          {pokeballButton("ditto")}
          {pokeballButton("magmar")}
          {pokeballButton("tentacool")}
          {pokeballButton("bulbasaur")}
        </div>
